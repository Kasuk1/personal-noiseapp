...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getCurrentUserTopArtists.pending, (state) => {
...
export const selectCurrentUserInfoIsLoading = (state) =>
  state.user.isUserInfoLoading;
export const selectCurrentErrorGetUserInfo = (state) =>
  state.user.errorGetUserInfo;

export const selectCurrentUserArtists = (state) => state.user.userArtists;
export const selectCurrentUserArtistsLoading = (state) =>
  state.user.isArtistsLoading;
export const selectCurrentErrorGetArtists = (state) =>
  state.user.errorGetArtists;
